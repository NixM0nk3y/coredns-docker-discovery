...
func (dd DockerDiscovery) resolveDomainsByContainer(container *types.ContainerJSON) ([]string, error) {
	var domains []string
...
func (dd DockerDiscovery) getContainerAddress(container *types.ContainerJSON) (net.IP, error) {
	for {
...
func (dd DockerDiscovery) updateContainerInfo(container *types.ContainerJSON) error {
...
func dockerEventHandler(dd *DockerDiscovery, msg events.Message) {
